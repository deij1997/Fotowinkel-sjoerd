 ...
 * @author Rowan
 */
@WebServlet(name = "UserInformationServlet", urlPatterns =
    {
        "/UserInformationServlet"
})
public class UserInformationServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        String name = "Koek", surname = "Cookingson", country = "Koeck",
                city = "Kook", street = "Kuukske",
                housenr = "555", postalcode = "555-555 KC", payment = "Koekjes";
