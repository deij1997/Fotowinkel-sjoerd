        ...
        <div class="container">
            <form id="upload-form" data-toggle="validator" role="form" class="upload-box" action="UploadServlet" method="post" enctype="multipart/form-data">
                ...
                <div id="uploadedImages" style="display: none;">
                    <h4 onclick="$('#UploadBox').fadeIn(200);" >&uarr;	Upload andere foto's</h4>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input type="email" class="form-control" id="inputEmail" placeholder="Klant e-mail" data-error="Het e-mailadres van de klant is vereist." required>
